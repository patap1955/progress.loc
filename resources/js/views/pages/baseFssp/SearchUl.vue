                ...
                <div class="p-fluid">
                    <div class="formgrid grid">
                        <div class="field col">
                            ...
                            <InputText v-model="name" id="name2" type="text" placeholder="Наименование организации" required/>
                        </div>
                        <div class="field col">
                            <label for="name">Адрес</label>
                            <InputText v-model="address" id="name" type="text" placeholder="Адрес организации" />
                        </div>
                    </div>
                </div>
