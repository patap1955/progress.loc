...
<template>
    <div className="card reestr">
        <div class="reestr__header">
            <h2>Поиск по номеру исполнительного производства</h2>
...
<!--            </div>-->
        ...
        <h3 v-if="result.error == true">Произошла ошибка при запросе. Попробуйте через 2 минуты повторить запрос </h3>
        <div v-if="loaded">
            <loader
                name="spinning"
                loadingText="Поиск"
