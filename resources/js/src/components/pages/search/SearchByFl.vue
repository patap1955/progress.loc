                            ...
                            <div class="search__form">
                                <div class="search__form-id">
                                    <div class="form-group">
                                        ...
                                        <input v-model="last_name" type="text" class="form-control" id="formGroupExampleInput" placeholder="Фамилия должника">
                                    </div>
                                    <div class="form-group">
                                        <label for="formGroupExampleInput" class="form-label">Имя</label>
                                        <input v-model="first_name" type="text" class="form-control" id="formGroupExampleInput" placeholder="Имя должника">
                                    </div>
                                    <div class="form-group">
                                        <label for="formGroupExampleInput" class="form-label">Отчество</label>
                                        <input v-model="patronymic" type="text" class="form-control" id="formGroupExampleInput" placeholder="Отчество должника">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="formGroupExampleInput" class="form-label">Дата рождения</label>
                                        <input v-model="date" type="text" class="form-control" id="formGroupExampleInput" placeholder="01.01.2021">
                                    </div>
                                </div>
...
export default {
    ...
    methods: {
        getResultsSearch() {
            this.loaded = true
            axios.get('/api/admin/search-by-fl', {
                params: {
